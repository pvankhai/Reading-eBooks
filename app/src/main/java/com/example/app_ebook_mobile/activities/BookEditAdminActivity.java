...
import com.example.app_ebook_mobile.databinding.ActivityBookEditAdminBinding;
...
public class BookEditAdminActivity extends AppCompatActivity {

    //view binding
    private ActivityBookEditAdminBinding binding;
    ...
    private static final String TAG = "BOOK_EDIT_ADMIN_TAG";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityBookEditAdminBinding.inflate(getLayoutInflater());
        ...
        ref.child(bookId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(BookEditAdminActivity.this, "Thông tin sách đã được cập nhật", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(BookEditAdminActivity.this, "Thông tin sách cập nhật thất bại", Toast.LENGTH_SHORT).show();
                    }
                });
    }
