...
import com.example.app_ebook_mobile.databinding.ActivityEpubAddAdminBinding;
...
public class BookAddAdminActivity extends AppCompatActivity {

    //Setup view Binding
    private ActivityEpubAddAdminBinding binding;
    ...
    //TAG for debugging
    private static final String TAG = "TAG_ADD_BOOK";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityEpubAddAdminBinding.inflate(getLayoutInflater());
    ...
    private void uploadEpubToStorage() {
        ...
        String filePathAndName = "Books/" + timestamp; // URL den quyen sach
        ...
        storageReference.putFile(epubUri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(BookAddAdminActivity.this, "Thêm sách không thành công" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        reference.child("" + timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(BookAddAdminActivity.this, "Thêm sách thành công", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(BookAddAdminActivity.this, "Thêm thông tin sách vào DB thất bại" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
