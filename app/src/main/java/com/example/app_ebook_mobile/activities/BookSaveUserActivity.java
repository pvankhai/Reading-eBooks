...
public class BookSaveUserActivity extends AppCompatActivity{
    ...
    //TAG for debugging
    private static final String TAG = "SAVE_BOOK_TAG";
        ...
        storageReference.putFile(epubUri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(BookSaveUserActivity.this, "Thêm sách không thành công" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        reference.child(firebaseAuth.getUid()).child("Books").child("" + timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(BookSaveUserActivity.this, "Thêm sách thành công", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(BookSaveUserActivity.this, "Thêm thông tin sách vào DB thất bại" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
