...
public class FilterBookUser extends Filter {
    ...
    AdapterBookUser adapterPdfUser;

    //constructor
    public FilterBookUser(ArrayList<ModelBook> filterList, AdapterBookUser adapterPdfUser){
    ...
    protected void publishResults(CharSequence constraints, FilterResults filterResults) {
        ...
        adapterPdfUser.pdfArrayList = (ArrayList<ModelBook>) filterResults.values;
